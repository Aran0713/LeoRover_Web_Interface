...
export default function CommandPanel() {
    ...
    }, [photosTaken, infiniteMode, durationSec]);
    ...
    }, [elapsedSec, timedStatus, durationSec, infiniteMode, photosTaken]);
  ...
  /* ---------- Functions ---------- */
    ...
    const stopAll = async () => {
        await run("stop", async () => {
            await api.stop(); // STOP now goes through YAMCS
        ...
        <div className="rounded-lg border border-gray-800 bg-gray-950/40 p-2 space-y-2">
            ...
            {timedStatus === "running" && (
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="font-semibold">{photosTaken}</div>
                    </div>
                </div>

                {infiniteMode && (
                    <div className="text-xs text-blue-300">
                    ∞ Infinite capture mode
                    </div>
                )}
